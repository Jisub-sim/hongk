   ...
   <div id="main">
    ...
    <div id="wrap_approver_div">
        ...
        <div id="des_approver">
         ...
         <!-- 결재 > 버튼 -->
        <div id="appbt_div">
            <button id="apselectbt" type="button">선 택 ></button>
        </div>
            <!--적용대상-->
...
// 							 	$n.attr('value',i);
							...
							var $Haname = $("<input type='hidden' name='Raname' class='Raname' value="+data.mName+">");
							...
							var $mn = $("<input type='hidden' name='mnoRHidden' class='mnoRHidden' value="+data.mNo+">");
		...
		$(function() { 
			$("#comSelectBt").click(function() { 
				var array = [];
			        ...
			        var answer = '참조자';//document.getElementsByClassName('mname').value;
			        
			        var mlist = new Array();
					   $("input[name=Raname]").each(function(index, item){
						   mlist.push($(item).val());
					   });
					   
					
					 parent.document.getElementById("referrerBt").value = mlist ;
					
					  var list = new Array();
					   $("input[name=mnoRHidden]").each(function(index, item){
						   list.push($(item).val());
					   });
