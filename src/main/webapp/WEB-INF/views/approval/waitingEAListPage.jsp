...
<body>
   ...
   <div id="main">
    ...
    <br><br><p style="width:90%;margin:auto;">결재 대기함 </p>
        ...
        <c:forEach var="ea" items="${list}">
            <tr>
                ...
                <td><c:url var="eadetail" value="eadetail.do">
                	<c:param name="CurPage" value="Wait"></c:param>
				...
				<c:if test="${ pi.currentPage > 1 }">
					<c:url var="before" value="wEAList.do">
				...
				<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
					...
					<c:if test="${ p ne pi.currentPage }">
						<c:url var="pagination" value="wEAList.do">
				...
				<c:if test="${ pi.currentPage < pi.maxPage }">
					<c:url var="after" value="wEAList.do">
						<c:param name="page" value="${ pi.currentPage + 1 }"/>
					</c:url>
					<a href="${ after }">[다음]</a>
				</c:if>
