...
<body>
   ...
   <div id="main">
    ...
    <br><br><p style="width:90%;margin:auto;">결재 진행함 </p>
            ...
            <tr>
                ...
                <td>
                	<c:url var="eadetail" value="eadetail.do">
                		<c:param name="CurPage" value="Progress"></c:param>
		  	...
		  	<tr align="center">
				...
				<c:if test="${ pi.currentPage > 1 }">
					<c:url var="before" value="progressEAList.do">
				...
				<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
					...
					<c:if test="${ p ne pi.currentPage }">
						<c:url var="pagination" value="progressEAList.do">
				...
				<c:if test="${ pi.currentPage < pi.maxPage }">
					<c:url var="after" value="progressEAList.do">
						<c:param name="page" value="${ pi.currentPage + 1 }"/>
					</c:url>
					<a href="${ after }">[다음]</a>
				</c:if>
