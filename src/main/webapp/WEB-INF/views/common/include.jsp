        ...
        <table id="login_area">
        	...
        	<tr>
        		<td colspan="2"><a href="" id="find_idpwd">아이디/비밀번호 찾기</a><br>
        		 <button href="" onclick="document.forms[0].submit();return false;" id="login_btn">로그인</button>
        	</tr>
        </table>
        </form>
        </c:if>
                 		...
                 		<!-- 친구 1명1명 -->
	                 			<div class="friend">
	                 				...
	                 				<input class="tomId" type="hidden" value="${ m.mId }"></input>
	                 			 	<p>
	                               		<strong>${ m.mName } / ${ m.jobCode } </strong><br>
	                               		<span>${ m.email } </span>
	                         	  	</p>
	                        	</div>
                 		</div>
