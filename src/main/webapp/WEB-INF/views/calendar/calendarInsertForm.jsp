...
<body>
	<div id="main">
        <h3 class="cal_category">일정 작성</h3><br>
        <div class="cal_wrap">
        <form action="<c:url value="calinsert.do"/>" id="cal_form" name="cal_form" onsubmit="return checkAll()">
	        <input type="hidden" name="mName" value="${ loginUser.mNo }">
            <table class="cal_table">
                <tr>
                    <td class="cal_td1"><p class="cal_td1_p">제목</p></td>
                    <td class="cal_td2"><input class="cal_title" name="cTitle"></td>
                </tr>
                <tr>
                    <td class="cal_td1"><p class="cal_td1_p">날짜</p></td>
                    <td class="cal_td2">
                        <input type="text" id="cal_startdate" name="cDate" value="${ cidate }">
                ...
                <tr>
                    ...
                    <td class="cal_td2">
                        <input class="cal_type" name="cKind">
                    </td>
                </tr>
                <tr>
                    <td class="cal_td1"><p class="cal_td1_p">장소</p></td>
                    <td class="cal_td2">
                        <input class="cal_location" name="cPlace">
                    </td>
                </tr>
                <tr>
                	<td class="cal_td1" colspan="2" align="center">
                	<input class="cal_submit" type="submit" value="등록하기"></td>
                </tr>
            </table>
        </form>
        </div>
    ...
    <script>
        ...
        /* function close_popup(){
        	document.getElementById('cal_form').action = 'calinsert.do';
